        ...
        <table className="table table-responsive">
          <thead className="table-secondary">
            <tr>
              ...
              <th scope="col" className="d-none d-sm-table-cell">Telefone</th>
                ...
                <td className="botoes-funcao">
                  ...
                  >
                    ...
                    >
                      ...
                      <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z" />
                      <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z" />
                    </svg>
                  </button>
                                ...
                                <div className="modal-body ">
                                  ...
                                  <div className="mb-3  modal-input">
                                    ...
                                    <input
                                      ...
                                      id="dwellingNumber"
                                      name="dwellingNumber"
                                      value={editedUser.dwellingNumber || ''}
                                      onChange={handleChange}
                                    />
                                  </div>
                                  <div className="mb-3  modal-input">
